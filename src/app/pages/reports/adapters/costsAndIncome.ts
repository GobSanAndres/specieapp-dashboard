...
function headersToData() {
  const headers = ['Nombre del negocio', 'Dirección del negocio', 'Creado por', 'Fecha de creación', 'Genero', 'identificación', 'nombre del informante', 'Localización', 'Nit', 'Tipo de persona', 'Nombre del producto', 'Número de registro', 'Fecha de actualización'];
  return headers;
}
