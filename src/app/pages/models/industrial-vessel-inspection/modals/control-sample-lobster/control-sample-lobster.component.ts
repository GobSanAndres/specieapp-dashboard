  ...
  */
  initForms() {
    this.formEditSampleLobster = this.formBuilder.group({
      number_seals: ['', [Validators.required, Validators.minLength(1)]],
      control_total_bags_landed: ['', [Validators.required, Validators.min(1)]],
      control_total_sealed_bags: ['', [Validators.required, Validators.min(1)]],
    });
