  ...
  getActivities(status:boolean) {
    ...
    this.activitiesService.getActivities(status).subscribe(
      (result: any) => {
        ...
        this.activitiesService.getFishingSite(true).subscribe(
          (efect: any) => {
        ...
        this.activitiesService.getFishingArt(true).subscribe(
          (efect: any) => {
        ...
        this.activitiesService.getUsers(true).subscribe(
          (efectuado: any) => {
  ...
  */
  ...
  updateDataActivities() {
    ...
    if (this.formEditActivities.invalid) {
      ...
      if (this.formEditActivities.value.observation.trim() === '') {
        this.formEditActivities.value.observation = 'Ninguna';
      }
      this.activitiesService.updateActivitie(this.formEditActivities.value).subscribe(
        ...
        (error) => {
          ...
          this.formEditActivities.patchValue({
            issue_date: this.transformEpoch(this.formEditActivities.value.issue_date),
          });
        },
      );
    }
