...
import { SpinyLobsterWeightCheckComponent } from './models/spiny-lobster-weight-check/spiny-lobster-weight-check.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    data: {
      title: 'Módulos',
      urls: [
        { title: 'Módulos', url: '/pages/forms-config/modules' },
  ...
  },
  {
    ...
    data: {
      title: 'Mediciones',
      urls: [
        { title: 'Pesca', url: '/pages/models/measurement' },
        { title: 'Mediciones de pesca' },
      ],
    },
  ...
  },
  {
    ...
    data: {
      title: 'Actividades',
      urls: [
        { title: 'Pesca', url: '/pages/models/activities' },
  ...
  },
  {
    ...
    data: {
      ...
      urls: [
        { title: 'Pesca', url: '/pages/models/weight-check' },
  ...
  },
  {
    ...
    data: {
      title: 'Desembarco',
      urls: [
        { title: 'Pesca', url: '/pages/models/monitoring' },
  ...
  },
  {
    ...
    data: {
      ...
      urls: [
        { title: 'Pesca', url: '/pages/models/industrial-vessel-inspection' },
  ...
  },
  {
    path: 'rgp-sai/boats',
    data: {
      title: 'Embarcaciones RGP-SAI',
      urls: [
        { title: 'RGP SAI' },
        { title: 'Data de embarcaciones RGP-SAI' },
      ],
    },
  ...
  },
  {
    ...
    data: {
      title: 'Pescadores RGP-SAI',
      urls: [
        { title: 'RGP SAI' },
        { title: 'Listado de pescadores RGP-SAI' },
      ],
    },
    component: FishermenComponent,
  },
  {
    path: 'models/spiny-lobster-weight-check',
    data: {
      title: 'Tallas y Medidas Langostas Espinosas',
      urls: [
        { title: 'Pesca', url: '/pages/models/spiny-lobster-weight-check' },
        { title: 'Tallas y medidas langostas espinosas' },
      ],
    },
    component: SpinyLobsterWeightCheckComponent,
  },
];
