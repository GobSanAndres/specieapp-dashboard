...
export class SectionsComponent implements OnInit {
   ...
   */
  filterSection(event:any, type) {
    const wordFilter:string = event.srcElement.value;
    if (type === 'desc') {
      (<HTMLInputElement>document.getElementById('search_form')).value = '';
      ...
      this.sectionArray = this.sectionArrayForFilter
        .filter((sectionArray) => sectionArray.form_available.description
          .toLocaleLowerCase().indexOf(wordFilter.toLocaleLowerCase()) !== -1);
    }
  }
    ...
    switch (tipo) {
      case 'modalEdit':
        ...
        if (pos !== -1) {
          ...
          } else if (dataForm.form_available.code === 'FO-MI-DP-08') {
            this.arrayNameTrue = arrayNamesQuestion['FO-MI-DP-08'];
      ...
      case 'select':
        ...
        if (pos !== -1) {
          if (this.formArray[pos].code === 'FO-MI-DP-03') {
            ...
            this.arrayNameTrue = arrayNamesQuestion['FO-MI-DP-07'];
          } else if (this.formArray[pos].code === 'FO-MI-DP-08') {
            this.arrayNameTrue = arrayNamesQuestion['FO-MI-DP-08'];
