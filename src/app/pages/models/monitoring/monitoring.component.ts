  ...
  getMonitoring(status:boolean) {
    ...
    this.monitoringService.getMonitoring(status).subscribe(
      (result: any) => {
        ...
        this.monitoringService.getGlobalArray(true).subscribe(
          (efect: any) => {
        ...
        this.monitoringService.getFishingSite(true).subscribe(
          (efect: any) => {
        ...
        this.monitoringService.getUsers(true).subscribe(
          (efect: any) => {
        ...
        this.monitoringService.getSpecies(true).subscribe(
          (efect: any) => {
        ...
        this.monitoringService.getFishingArea(true).subscribe(
          (efect: any) => {
        ...
        this.monitoringService.getFishingArt(true).subscribe(
          (efect: any) => {
        ...
        this.monitoringService.getFishingMethod(true).subscribe(
          (efect: any) => {
        ...
        this.monitoringService.getBoat(true).subscribe(
          (efect: any) => {
        ...
        this.monitoringService.getPropulsionMethod(true).subscribe(
          (efect: any) => {
  ...
  */
  initForms() {
    ...
    this.formEditOperatingExpense = this.formBuilder.group({
      _id: [''],
      gasoline_oneday: ['', [Validators.minLength(1), Validators.maxLength(10)]],
      other_oneday: ['', [Validators.minLength(1), Validators.maxLength(10)]],
      groceries_higherday: ['', [Validators.minLength(1), Validators.maxLength(10)]],
      ice_higherday: ['', [Validators.minLength(1), Validators.maxLength(10)]],
      gasoline_higherday: ['', [Validators.minLength(1), Validators.maxLength(10)]],
      bait_higherday: ['', [Validators.minLength(1), Validators.maxLength(10)]],
    });
    ...
    this.formEditLanded = this.formBuilder.group({
      ...
      status: ['', [Validators.required, Validators.minLength(1), Validators.maxLength(15)]],
      weight: ['', [Validators.required, Validators.minLength(1), Validators.maxLength(15)]],
    });
  }
