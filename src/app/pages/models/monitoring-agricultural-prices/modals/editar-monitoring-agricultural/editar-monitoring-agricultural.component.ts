...
export class EditarMonitoringAgriculturalComponent implements OnInit {
  ...
  formMonitoringInitialize() {
    this.formMonitoring = this.formBuilder.group({
      ...
      business_address_establishment: ['', [Validators.required, Validators.minLength(4), Validators.maxLength(64)]],
  ...
  fillFormMonitoring() {
    this.formMonitoring.patchValue({
      ...
      business_address_establishment: this.monitoring.business_address_establishment,
  ...
  validateMonitoringForm() {
    ...
    this.formMonitoring.patchValue({
      ...
      business_address_establishment:
        this.formMonitoring.value.business_address_establishment.trim(),
