...
function adapterData(arrayData:any[]) {
  const newData = arrayData.map((industrialInspection) => {
    const adapter = {
      ...
      captain_name: industrialInspection.captain_name,
...
function headersToData() {
  const headers = ['Número de registro', 'Fecha de arribo', 'Nombre de la embarcación', 'Nombre del capitán', 'Total de bolsas desembarcadas', 'Total de bolsas selladas', 'Creado por', 'Fecha creación', 'Esfuerzo de buso por dia', 'Número de busos por panga', 'Número de buseo de pangas por dia', 'Fecha de expiración', 'Registrador de campo', 'Esfuerzo de nasas de pescado por dia', 'Número de nasas de pescado por dia', 'Tipo de nasas de pescado', 'Sitio de desembarque', 'Esfuerzo de nasas langosteras', 'Número de nasas langosteras en linea por día', 'Número de nasas langosteras en linea', 'Número de nasas langosteras lingadas', 'Long line', 'Número de tripulantes continentales', 'Número de tripulantes extranjeros', 'Número de tripulantes residentes', 'Número de pescadores continental', 'Número de pescadores extranjeros', 'Número de pescadores residentes', 'Observación', 'Número de patente', 'Titular del permiso', 'Fecha de sarpe', 'Tipo de pesqueria', 'Fecha de actualización'];
  return headers;
}
