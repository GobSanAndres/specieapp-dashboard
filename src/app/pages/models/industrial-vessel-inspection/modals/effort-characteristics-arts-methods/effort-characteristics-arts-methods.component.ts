  ...
  */
  initForms() {
    this.formEditEffortCharacteristic = this.formBuilder.group({
      long_line: ['', [Validators.required]],
      reel: ['', [Validators.required, Validators.minLength(1)]],
      longLine: ['', [Validators.required, Validators.minLength(1)]],
    });

    this.formEditReel = this.formBuilder.group({
      _id: [''],
      effort_reel_perday: ['', [Validators.minLength(0)]],
      hook_gauge: ['', [Validators.minLength(0)]],
      hook_type: ['', [Validators.minLength(0)]],
      number_hooks: ['', [Validators.minLength(0)]],
      number_reel_perday: ['', [Validators.minLength(0)]],
      type: ['', [Validators.minLength(0)]],
    });

    this.formEditLongLine = this.formBuilder.group({
      _id: [''],
      sets_number_perday: ['', [Validators.minLength(0)]],
      sets_number: ['', [Validators.minLength(0)]],
      sets_hook_type: ['', [Validators.minLength(0)]],
      sets_hook_gauge: ['', [Validators.minLength(0)]],
      sets_effort_hook_perday: ['', [Validators.minLength(0)]],
    });
  }
  ...
  saveLongLine(event: any) {
    this.dataForm.value.long_line = event.target.value;
  }
