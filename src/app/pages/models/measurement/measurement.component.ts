  ...
  getMeasurement(status:boolean) {
    ...
    this.measurementService.getMeasurement(status).subscribe(
      (result: any) => {
        ...
        this.measurementService.getFishingSite(true).subscribe(
          (efect: any) => {
        ...
        this.measurementService.getFishingArea(true).subscribe(
          (efect: any) => {
        ...
        this.measurementService.getFishingArt(true).subscribe(
          (efect: any) => {
        ...
        this.measurementService.getUsers(true).subscribe(
          (efectuado: any) => {
        ...
        this.measurementService.getSpecies(true).subscribe(
          (efectuado: any) => {
  ...
  */
  initForms() {
    ...
    this.formEditSpecie = this.formBuilder.group({
      ...
      longitud: [0, [Validators.required, Validators.min(1)]],
      frecuency: [0, [Validators.required, Validators.min(1)]],
    });
  }
    ...
    if (this.formEditMeasurement.invalid) {
      ...
      this.measurementService.updateMeasurement(this.formEditMeasurement.value).subscribe(
        ...
        (error) => {
          ...
          this.formEditMeasurement.patchValue({
            issue_date: this.transformEpoch(this.formEditMeasurement.value.issue_date),
          });
        },
      );
    }
